...
@implementation DGCSVGAContentLayer
...
- (void)setBitmapLayer:(DGCSVGABitmapLayer *)bitmapLayer {
    [_bitmapLayer removeFromSuperlayer];
    _bitmapLayer = bitmapLayer;
    [self addSublayer:bitmapLayer];
}

- (void)setVectorLayer:(DGCSVGAVectorLayer *)vectorLayer {
