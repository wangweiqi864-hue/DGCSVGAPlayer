...
@implementation DGCSVGAVectorLayer
...
- (void)resetKeepFrameCache {
    ...
    [self.frames enumerateObjectsUsingBlock:^(DGCSVGAVideoSpriteFrameEntity * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (BOOL)isKeepFrame:(DGCSVGAVideoSpriteFrameEntity *)frameItem {
    ...
    else if ([frameItem.shapes.firstObject isKindOfClass:[DGCSVGAProtoShapeEntity class]]) {
        return [(DGCSVGAProtoShapeEntity *)frameItem.shapes.firstObject type] == SVGAProtoShapeEntity_ShapeType_Keep;
    }
    else {
        return NO;
    }
...
- (void)drawFrame:(NSInteger)frame {
    if (frame < self.frames.count) {
        DGCSVGAVideoSpriteFrameEntity *frameItem = self.frames[frame];
        ...
        for (NSDictionary *shape in frameItem.shapes) {
            ...
            else if ([shape isKindOfClass:[DGCSVGAProtoShapeEntity class]]) {
                DGCSVGAProtoShapeEntity *shapeItem = (id)shape;
...
- (CALayer *)createCurveLayer:(NSDictionary *)shape {
    DGCSVGABezierPath *bezierPath = [DGCSVGABezierPath new];
...
- (CALayer *)createCurveLayerWithProto:(DGCSVGAProtoShapeEntity *)shape {
    DGCSVGABezierPath *bezierPath = [DGCSVGABezierPath new];
...
- (CALayer *)createEllipseLayerWithProto:(DGCSVGAProtoShapeEntity *)shape {
    UIBezierPath *bezierPath;
...
- (CALayer *)createRectLayerWithProto:(DGCSVGAProtoShapeEntity *)shape {
    UIBezierPath *bezierPath;
...
- (void)resetStyles:(CAShapeLayer *)shapeLayer protoShape:(DGCSVGAProtoShapeEntity *)protoShape {
    shapeLayer.masksToBounds = NO;
    shapeLayer.backgroundColor = [UIColor clearColor].CGColor;
...
- (void)resetTransform:(CAShapeLayer *)shapeLayer protoShape:(DGCSVGAProtoShapeEntity *)protoShape {
