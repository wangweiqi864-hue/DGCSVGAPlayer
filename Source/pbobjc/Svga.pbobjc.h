...
@class DGCSVGAProtoLayout;
@class DGCSVGAProtoMovieParams;
@class DGCSVGAProtoShapeEntity;
@class DGCSVGAProtoShapeEntity_EllipseArgs;
@class DGCSVGAProtoShapeEntity_RectArgs;
@class DGCSVGAProtoShapeEntity_ShapeArgs;
@class DGCSVGAProtoShapeEntity_ShapeStyle;
@class DGCSVGAProtoShapeEntity_ShapeStyle_RGBAColor;
@class DGCSVGAProtoSpriteEntity;
@class DGCSVGAProtoTransform;
 ...
 **/
@interface DGCSVGAProtoSvgaRoot : GPBRootObject
@end
...
@interface DGCSVGAProtoMovieParams : GPBMessage
...
@interface DGCSVGAProtoSpriteEntity : GPBMessage
...
/** 帧列表 */
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<DGCSVGAProtoFrameEntity*> *framesArray;
...
@interface DGCSVGAProtoAudioEntity : GPBMessage
...
@interface DGCSVGAProtoLayout : GPBMessage
...
@interface DGCSVGAProtoTransform : GPBMessage
...
@interface DGCSVGAProtoShapeEntity : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_ShapeArgs *shape;

@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_RectArgs *rect;

@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_EllipseArgs *ellipse;

/** 渲染参数 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_ShapeStyle *styles;
/** Test to see if @c styles has been set. */
@property(nonatomic, readwrite) BOOL hasStyles;

/** 矢量图层 2D 变换矩阵 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoTransform *transform;
...
/**
 * Fetches the raw value of a @c DGCSVGAProtoShapeEntity's @c type property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t SVGAProtoShapeEntity_Type_RawValue(DGCSVGAProtoShapeEntity *message);
/**
 * Sets the raw value of an @c DGCSVGAProtoShapeEntity's @c type property, allowing
...
@interface DGCSVGAProtoShapeEntity_ShapeArgs : GPBMessage
...
@interface DGCSVGAProtoShapeEntity_RectArgs : GPBMessage
...
@interface DGCSVGAProtoShapeEntity_EllipseArgs : GPBMessage
...
@interface DGCSVGAProtoShapeEntity_ShapeStyle : GPBMessage

/** 填充色 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_ShapeStyle_RGBAColor *fill;
/** Test to see if @c fill has been set. */
@property(nonatomic, readwrite) BOOL hasFill;

/** 描边色 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoShapeEntity_ShapeStyle_RGBAColor *stroke;
...
/**
 * Fetches the raw value of a @c DGCSVGAProtoShapeEntity_ShapeStyle's @c lineCap property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t SVGAProtoShapeEntity_ShapeStyle_LineCap_RawValue(DGCSVGAProtoShapeEntity_ShapeStyle *message);
/**
 * Sets the raw value of an @c DGCSVGAProtoShapeEntity_ShapeStyle's @c lineCap property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
/**
 * Fetches the raw value of a @c DGCSVGAProtoShapeEntity_ShapeStyle's @c lineJoin property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t SVGAProtoShapeEntity_ShapeStyle_LineJoin_RawValue(DGCSVGAProtoShapeEntity_ShapeStyle *message);
/**
 * Sets the raw value of an @c DGCSVGAProtoShapeEntity_ShapeStyle's @c lineJoin property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
@interface DGCSVGAProtoShapeEntity_ShapeStyle_RGBAColor : GPBMessage
...
@interface DGCSVGAProtoFrameEntity : GPBMessage

/** 透明度 */
@property(nonatomic, readwrite) float alpha;

/** 初始约束大小 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoLayout *layout;
...
/** 矢量元素列表 */
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<DGCSVGAProtoShapeEntity*> *shapesArray;
...
@interface DGCSVGAProtoMovieEntity : GPBMessage

/** DGCSVGA 格式版本号 */
@property(nonatomic, readwrite, copy, null_resettable) NSString *version;

/** 动画参数 */
@property(nonatomic, readwrite, strong, null_resettable) DGCSVGAProtoMovieParams *params;
...
/** 元素列表 */
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<DGCSVGAProtoSpriteEntity*> *spritesArray;
...
/** 音频列表 */
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<DGCSVGAProtoAudioEntity*> *audiosArray;
